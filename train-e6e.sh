...
python train_aux.py --device 0 --batch-size 8 --data data/barley.yaml --img 1280 1280 --cfg cfg/training/yolov7-e6e.yaml --weights '' --name e6e --hyp data/hyp.scratch.p6.yaml
